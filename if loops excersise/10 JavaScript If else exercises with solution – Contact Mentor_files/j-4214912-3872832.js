//Generated:2022-08-11 20:46:30// 6-269
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4214912 || '',
    guid: window.ftGUID_4214912 || '',
    confID: window.ftConfID_4214912 || '0',
    ftReturn: window.ftReturn_4214912 || '',
    keyword: window.ftKeyword_4214912 || '',
    ftId: window.ftId_4214912 || '',
    ftImpId: window.ftImp4214912 && window.ftImp4214912.impID || '',
    gdpr: window.ftImp4214912 && window.ftImp4214912.gdpr || '',
    gdpr_consent: window.ftImp4214912 && window.ftImp4214912.gdpr_consent || '',
    gdpr_pd: window.ftImp4214912 && window.ftImp4214912.gdpr_pd || '',
    us_privacy: window.ftImp4214912 && window.ftImp4214912.us_privacy || '',
    campaignID: '115843',
    cID: '155443',
    pID: '4214912',
    creativeID: '3872832',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115843&sid=18330&plc=4214912&num=&adid=&advid=&adsrv=29&btreg=4214912&btadsrv=flashtalking&crt=3872832&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115843;4214912;3872832;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?221671174-4214912;3872832;',
    centreAd: false,
    width: 300,
    height: 600,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/421/4214912/3872832/image/3872832.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115843;4214912;202;pixel;DV360;DV360FY20CCCTXCategoryINDSKBAN300x600/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115843;4214912;3872832;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=600&url=https://www.adobe.com/in/creativecloud/plans.html?plan=individual&sdid=GZKZY1B7&mv=display",
    divID: 'ftdiv4214912',
    altimgID: 'ftalt4214912',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4214912 && parseInt(window.ftImp4214912.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4214912') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4214912'),
    pageVisible: 'maybe',
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4214912").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4214912").style.display = "none";
		    }
		});
	}
}(ft4214912));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115843&l2=DV360&l3=4214912&l4=3872832&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115843&l2=DV360&l3=4214912&l4=3872832&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
window.setTimeout(function() {
    var b = window.ft4214912,
        ...
        l = function () {
            ...
            divElement.style.cssText = "position:absolute; top:0px; left:0px; z-index: 999999;";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4214912;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4214912;
